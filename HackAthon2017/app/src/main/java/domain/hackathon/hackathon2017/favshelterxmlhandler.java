...
public class favshelterxmlhandler {
    ...
    public favshelterxmlhandler(String url) {
        urlstring = url;
    }
                ...
                switch (event) {
                    ...
                    case XmlPullParser.END_TAG:
                        ...
                        switch (name) {
                            ...
                            case "email":
                                Emailaccount = text;
                                Fav_ShelterInfo.tempholder = new Shelterholder(Sheletername,Adress,state,city,country,zipcode,phonenumber,Emailaccount);
                                break;
                            default:
                                break;
                        }
