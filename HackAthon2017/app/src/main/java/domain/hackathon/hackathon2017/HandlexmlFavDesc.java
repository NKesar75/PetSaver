...
public class HandlexmlFavDesc {
    ...
    public HandlexmlFavDesc(String url) {
        urlstring = url;
    }
                        ...
                        switch (name) {
                            ...
                            case "photo":
                                if (hasbeencalledimage == false) {
                                    image = text;
                                    Fav_Desc.petdescinfo = new PetInfo(image, age, Integer.parseInt(petid), breed, animalname, shelterid, animaltype, gender, Size);
